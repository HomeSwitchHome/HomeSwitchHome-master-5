...
if(!empty($_POST))
    ...
    if(isset($_POST["prenom"], $_POST["nom"], $_POST["email"], $_POST["mdp"], $_POST["check_mdp"], $_POST["age"]))
    	{
    	...
    	if(count($messages) === 0)
			...
			try
                {
                $register = $bdd->prepare("INSERT INTO membres (prenom, nom, email, mdp, age) VALUES (:prenom, :nom, :email, :mdp, :age)");
